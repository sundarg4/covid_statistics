...
class HorizontalBarChart extends Component {
    ...
    createHorizontalBarChart() {
        var node = this.node;
        var width = (this.props.options && this.props.options.width) ? this.props.options.width : 550,
        ...
        var svg = d3.select(node)
            ...
            .attr("viewBox", "0 -5 " + (width + margin.left + margin.right) + " " + (height + margin.top + margin.bottom) + "");
